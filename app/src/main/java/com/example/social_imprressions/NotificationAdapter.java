...
public class NotificationAdapter extends RecyclerView.Adapter<NotificationAdapter.viewHolder> {
    ...
    public NotificationAdapter(ArrayList<com.example.socialimpressions.NotificationModel> list, Context context) {
        this.list = list;
    ...
    public void onBindViewHolder(@NonNull viewHolder holder, int position) {
        com.example.socialimpressions.NotificationModel model = list.get(position);
