...
public class DashboardAdapter extends RecyclerView.Adapter<DashboardAdapter.viewHolder> {
    ...
    ArrayList<com.example.socialimpressions.DashboardModel> list;
    Context context;
    boolean clicked = false;
    int likeCount;

    public DashboardAdapter(ArrayList<com.example.socialimpressions.DashboardModel> list, Context context) {
        this.list = list;
    ...
    public void onBindViewHolder(@NonNull viewHolder holder, int position) {
        com.example.socialimpressions.DashboardModel model = list.get(position);
